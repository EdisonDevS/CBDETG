	...
	def roomTypeSelector(self):
		...
		return random.choice(
			[
				...
				[#azul
					([1,2],[0.8, 0.2]),
					(([5000,5000,1,2], [17,18,1,2]), [0.3,0.2,0.3,0.2]),
					([5,6], [0.8, 0.2])
				],
				[#oscuro
					([7,8],[0.8, 0.2]),
					(([5000,5000,7,8], [5,6,7,8]), [0.3,0.2,0.3,0.2]),
					([11,12], [0.8, 0.2])
				],
				[#arenizca
					([13,14],[0.8, 0.2]),
					(([5000,5000,13,14], [11,12,13,14]), [0.3,0.2,0.3,0.2]),
					([17,18], [0.8, 0.2])
				],
				[#nieve
					([19,20],[0.8, 0.2]),
					(([5000,5000,20], [24,25,20]), [0.5,0.3,0.2]),
					([22,23], [0.8, 0.2])
				]
			]
			)

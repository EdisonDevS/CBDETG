	...
	def roomTypeSelector(self):
		...
		return random.choice(
			[
				[#azul
					([1,2],[0.8, 0.2]),
					(([3,4,1,2,5000], [17,18,1,2,5]), [0.3,0.2,0.3,0.1,0.1]),
					([5,6], [0.8, 0.2])
				],
				[#oscuro
					([7,8],[0.8, 0.2]),
					(([9,10,7,8, 5000], [5,6,7,8,11]), [0.3,0.2,0.3,0.1,0.1]),
					([11,12], [0.8, 0.2])
				],
				[#arenizca
					([13,14],[0.8, 0.2]),
					(([15,16,13,14,5000], [11,12,13,14,17]), [0.3,0.2,0.3,0.1,0.1]),
					([17,18], [0.8, 0.2])
				],
				[#nieve
					([19,20],[0.8, 0.2]),
					(([21,19,20, 5000], [24,25,20,22]), [0.5,0.3,0.1,0.1]),
					([22,23], [0.8, 0.2])
				]
			]
			)
